...
class WanModelStateDictConverter:
    ...
    def from_civitai(self, state_dict):
        ...
        elif hash_state_dict_keys(state_dict) == "d9c91561d7feb8510857001e88c410db":
            # 14B I2V Control
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
        ...
        elif hash_state_dict_keys(state_dict) == "16266d0dbcda81a4f797d7b8aafe0f35":
            # 14B I2V Control lora only context
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
                "in_dim": 36,
        ...
        elif hash_state_dict_keys(state_dict) == "dd9ee3cc97642977beab8e12d2610a19":
            # 14B I2V Control lora only context 最新
            config = {
                "has_image_input": True,
                "patch_size": [1, 2, 2],
                "in_dim": 36,
        ...
        elif hash_state_dict_keys(state_dict) == "3803bd491e969952cbbeb1a48fd8fa11":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "0afc12f0f89f5602ca0fb44998d5fab3":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "e8102511f92a240dba2d577218fcf6f1":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "452867c4b22ec0fe62015e2202561f4f":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "e2e520f6b0b7307b8a9a8dd5bd8c020a":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "948982ad6c57e8cc51e334334511ba56":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "2df9f0f2bf2da1682b22717ea0d1db48":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "72eb2cd6726a61792fe75c49e2b68d34":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "bef5b7059ced61357ef5c55eff4cd2f4":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "4e9d80607c71d650e185ae3edab2e6be":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "9174f2c68848bb65480dd4cc5dcbb6f1":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
        ...
        elif hash_state_dict_keys(state_dict) == "d8ee7cda0d764f06b42d5313acbb9187":
            # 1.3B PAI control-camera v1.1
            # 这里作出修改
            config = {
                "has_image_input": True,
